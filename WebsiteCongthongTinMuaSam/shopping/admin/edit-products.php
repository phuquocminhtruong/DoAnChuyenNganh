...
<div class="controls">
<input type="text" onkeypress="validate(event)"   name="productprice"  placeholder="Enter Product Price" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
<script>
